...
awful.rules.rules = {
    ...
    { rule = { class = "Google-chrome" },
      except_any = { name = "TweetDeck", name = "Netflix", name = "Prime Video" },
      properties = { screen = 1, tag = tag_2 } },
    { rule = { name = "TweetDeck" },
      properties = { screen = 1, tag = tag_4 } },
    { rule = { name = "Netflix" },
      properties = { screen = 1, sticky = true, floating = true },
      tags = { tag_1, tag_2, tag_3, tag_4 } },
    { rule = { name = "Prime Video" },
      properties = { screen = 1, sticky = true, floating = true },
      tags = { tag_1, tag_2, tag_3, tag_4 } },
    { rule = { class = "chromium" },
      properties = { screen = 1, tag = tag_2 } },
